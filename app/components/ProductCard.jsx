    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 my-6">
      {products.map((product) => (
        <Link href={`/products/${product._id}`} key={product._id}>
          <div className="bg-white relative cursor-pointer  hover:border-none shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] hover:shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] flex flex-col  justify-center p-2  h-full rounded-md">
